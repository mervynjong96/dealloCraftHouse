<?php
    ...
    if( 
		...
		if($new_quantity < 1){
			...
			$query = "UPDATE $cart_table SET product_quantity = product_quantity + '$new_quantity' WHERE userid='$userid' AND product_id='$product_id' ";
		...
		echo "Something goes 456 wrong, Please try again later";
